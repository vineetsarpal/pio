  ...
  return (
    <main className="min-h-screen bg-fog/90 px-4 py-5 text-ink sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-7xl flex-col gap-5">
        <div className="flex flex-col gap-3 rounded-lg border border-amber/40 bg-amber/10 p-4 text-sm leading-6 text-slate-700 md:flex-row md:items-center md:justify-between">
          <p>
            <strong>Hackathon demo only.</strong> This operator dashboard demonstrates parametric
            coverage controls with Stripe test mode. It does not issue real insurance, coverage, or
            legally binding payouts.
          </p>
          <div className="flex shrink-0 flex-wrap gap-3">
            <a className="font-semibold text-rain" href="/">
              Home
            </a>
            <a className="font-semibold text-rain" href="/buy">
              Quote coverage
            </a>
          </div>
        </div>
